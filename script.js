...
var myage = document.getElementById("noun4").value;
...
// Line 12 & 13 are to save the completed story element as a string data in the database 
// From line 16 to 26 we are going to save the story in the database.
var storyData = {
  timestamp: Date.now(),
  story: story,
  castle: castle,
